...
<html lang="en">
  <head>
    ...
    <!-- Loading Bootstrap -->
    <link href="${ctx}/pages/dist/css/vendor/bootstrap.min.css" rel="stylesheet">

    <!-- Loading Flat UI -->
    <link href="${ctx}/pages/dist/css/flat-ui.css" rel="stylesheet">
    <link href="${ctx}/pages/docs/assets/css/demo.css" rel="stylesheet">

    <link rel="shortcut icon" href="img/favicon.ico">

    <!-- HTML5 shim, for IE6-8 support of HTML5 elements. All other JS at the end of file. -->
    <!--[if lt IE 9]>
      <script src="${ctx}/pages/dist/js/vendor/html5shiv.js"></script>
      <script src="${ctx}/pages/dist/js/vendor/respond.min.js"></script>
    <![endif]-->
  </head>
  <body>
    <div class="container">
      ...
      <div class="demo-row typography-row">
      	...
      	<div class="demo-content">
	          ...
	          <img src="${ctx}/pages/docs/assets/img/example-image.jpg" alt="example-image" class="img-rounded img-responsive">
      ...
      <div class="demo-illustrations">
        <div class="demo-content">
          <div><img src="${ctx}/pages/img/icons/svg/toilet-paper.svg" alt="Toilet-Paper"></div>
          <div><img src="${ctx}/pages/img/icons/svg/gift-box.svg" alt="Gift-Box"></div>
          <div><img src="${ctx}/pages/img/icons/svg/pencils.svg" alt="Pensils"></div>
          <div><img src="${ctx}/pages/img/icons/svg/clipboard.svg" alt="Clipboard"></div>
          <div><img src="${ctx}/pages/img/icons/svg/retina.svg" alt="Retina"></div>
          <div><img src="${ctx}/pages/img/icons/svg/compas.svg" alt="Compas"></div>
          <div><img src="${ctx}/pages/img/icons/svg/map.svg" alt="Map"></div>
          <div><img src="${ctx}/pages/img/icons/svg/chat.svg" alt="Chat"></div>
          <div><img src="${ctx}/pages/img/icons/svg/mail.svg" alt="Mail"></div>
          <div><img src="${ctx}/pages/img/icons/svg/book.svg" alt="Book"></div>
          <div><img src="${ctx}/pages/img/icons/svg/calendar.svg" alt="Calendar"></div>
          <div><img src="${ctx}/pages/img/icons/svg/paper-bag.svg" alt="Pocket"></div>
          <div><img src="${ctx}/pages/img/icons/svg/clocks.svg" alt="Watches"></div>
          <div><img src="${ctx}/pages/img/icons/svg/loop.svg" alt="Infinity-Loop"></div>
        </div>
      </div>
      ...
      <div class="row demo-samples">
        ...
        <div class="col-xs-8">
          <video class="video-js" preload="auto" poster="${ctx}/pages/docs/assets/img/video/poster.jpg" data-setup="{}">
      ...
      <div class="row demo-tiles">
        <div class="col-xs-3">
          <div class="tile">
            <img src="${ctx}/pages/img/icons/svg/compas.svg" alt="Compas" class="tile-image big-illustration">
        ...
        <div class="col-xs-3">
          <div class="tile">
            <img src="${ctx}/pages/img/icons/svg/loop.svg" alt="Infinity-Loop" class="tile-image">
        ...
        <div class="col-xs-3">
          <div class="tile">
            <img src="${ctx}/pages/img/icons/svg/pencils.svg" alt="Pensils" class="tile-image">
        ...
        <div class="col-xs-3">
          <div class="tile tile-hot">
            <img src="${ctx}/pages/img/icons/svg/ribbon.svg" alt="ribbon" class="tile-hot-ribbon">
            <img src="${ctx}/pages/img/icons/svg/chat.svg" alt="Chat" class="tile-image">
      ...
      <div class="login">
        <div class="login-screen">
          <div class="login-icon">
            <img src="${ctx}/pages/img/login/icon.png" alt="Welcome to Mail App" />
      ...
      <div class="row">
        <div class="col-xs-9">
          <div class="demo-browser">
            ...
            <div class="demo-browser-content">
              <img src="${ctx}/pages/docs/assets/img/demo/browser-pic-1.jpg" alt="" />
              <img src="${ctx}/pages/docs/assets/img/demo/browser-pic-2.jpg" alt="" />
              <img src="${ctx}/pages/docs/assets/img/demo/browser-pic-3.jpg" alt="" />
              <img src="${ctx}/pages/docs/assets/img/demo/browser-pic-4.jpg" alt="" />
              <img src="${ctx}/pages/docs/assets/img/demo/browser-pic-5.jpg" alt="" />
              <img src="${ctx}/pages/docs/assets/img/demo/browser-pic-6.jpg" alt="" />
            </div>
          </div>
        </div>
        ...
        <div class="col-xs-3">
          <div class="demo-download">
            <img src="${ctx}/pages/docs/assets/img/demo/html-icon.png" src="Free PSD" />
          </div>
        ...
        <div class="row">
          <div class="col-xs-7">
            ...
            <a class="footer-brand" href="http://designmodo.com" target="_blank">
              <img src="${ctx}/pages/docs/assets/img/footer/logo.png" alt="Designmodo.com" />
            </a>
          </div> <!-- /col-xs-7 -->
    ...
    <script src="${ctx}/pages/dist/js/vendor/jquery.min.js"></script>
    <script src="${ctx}/pages/dist/js/vendor/video.js"></script>
    <script src="${ctx}/pages/dist/js/flat-ui.min.js"></script>
    <script src="${ctx}/pages/docs/assets/js/application.js"></script>
